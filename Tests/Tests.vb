    ...
    Module Main
        Function RunTests(projectRoot As String,
            ...
            If runWin32Tests Then
                ...
                If Not Test_Symlinks1_Final(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks1_Target(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks2_Final() Then returnVal = False
                If Not Test_Symlinks2_Target() Then returnVal = False
                If Not Test_Symlinks3_Final(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks3_Target(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks4_Final(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks4_Target(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks5_Final(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks5_Target(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks6_Final(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks6_Target(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks7_Final(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks7_Target(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks8_Final(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks8_Target(rootTestFolder) Then returnVal = False
                If Not Test_Symlinks9() Then returnVal = False
                If Not Test_Symlinks10() Then returnVal = False
                If Not Test_Symlinks11(rootTestFolder) Then returnVal = False
                If Not Test_SymlinkThrows1(rootTestFolder) Then returnVal = False
                ...
                If Not Test_SymlinkThrows4() Then returnVal = False
                If Not Test_SymlinkThrows5() Then returnVal = False
                If Not Test_SymlinkThrows6() Then returnVal = False
                If Not Test_SymlinkThrows7() Then returnVal = False
                If Not Test_SymlinkThrows8(rootTestFolder) Then returnVal = False
                ...
                If Not Test_HardlinkThrows5(rootTestFolder) Then returnVal = False
                If Not Test_HardlinkThrows6(rootTestFolder) Then returnVal = False
                If Not Test_HardlinkThrows7() Then returnVal = False
                If Not Test_HardlinkThrows8() Then returnVal = False
                If Not Test_HardlinkThrows9(rootTestFolder) Then returnVal = False
            ...
            If runArgHandlerTests Then
                ...
                If Not Test_ArgHandler13() Then returnVal = False
            End If
